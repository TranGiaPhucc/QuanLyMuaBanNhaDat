...
<!-----Main------>
	<div class="container-fluid">
		...
		<div class="col-xl-9 col-lg-9 col-md-12 col-12">
				...
				<div class="card mb-4">
      <div class="card-body">
      <h4 class="card-title mb-4" style="align-items: center">Thanh Toán</h4>
      <form role="form">
...
<div class="row">
    <div class="col-md flex-grow-0">
        <div class="form-group">
            <label><span class="hidden-xs">Thời Gian</span> </label>
...
<p class="alert alert-success"> <i class="fa fa-lock"></i>Thông Tin Của Bạn Được Bảo Mật An Toàn </p>
