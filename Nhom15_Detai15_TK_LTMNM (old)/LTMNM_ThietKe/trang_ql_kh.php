...
$total_records = $conn->query("SELECT COUNT(*) AS total FROM khachhang")->fetchColumn();
			...
			<div class="col-xl-3 col-lg-3 col-md-4 col-6">
				<aside class="">
                    <nav class="list-group">
                        ...
                        <a class="list-group-item  active" href="#">Quản Lý Khách Hàng</a>
      ...
      <div class="modal-content">
		...
		<form action="ThemKH.php" method="POST"  onsubmit="return Validate()">
            <div class="form-group">
                ...
                <input type="text" name="idkhachhang" id="idkhachhang" class="form-control">
