...
<!-----Main------>
			...
			<div class="col-xl-3 col-lg-3 col-md-4 col-6">
				<aside class="">
                    <nav class="list-group">
						...
						<a class="list-group-item active" href="#">Thông Kê Doanh Số </a>
    ...
    <?php
        // Mô phỏng dữ liệu doanh thu theo tháng
        $revenueData = [
            'Tháng 1' => 5000,
            'Tháng 2' => 7000,
            'Tháng 3' => 9000,
        ...
        $revenueDataJson = json_encode(array_values($revenueData));
        $labelsJson = json_encode(array_keys($revenueData));
    ?>
