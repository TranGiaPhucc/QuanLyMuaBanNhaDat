			...
			<div class="col-xl-3 col-lg-3 col-md-4 col-6">
				<aside class="">
                    <nav class="list-group">
						...
						<a class="list-group-item" href="#">Quản Lý Mua Thuê</a>
...
<input type="text" class="form-control" name="username" placeholder="Nguyen Van A" required="">
</div> <!-- form-group.// -->
<div class="form-group">
<label for="username">Số Sao</label>
<input type="text" class="form-control" name="sosao"re quired="">
</div> <!-- form-group.// -->
<div class="form-group">
<label for="username">Content</label>
<input type="text" class="form-control" name="content"re quired="">
</div> <!-- form-group.// -->

<button class="subscribe btn btn-primary btn-block" type="button">Đánh Giá</button>
</form>
      </div> <!-- card-body.// -->
    </div> <!-- card .// -->
			</div>
