...
if (isset($_SESSION['username'])) {
   ...
   // $address = $employee['DiaChi'];
    ...
    // Nếu không có session, chuyển hướng về trang đăng nhập hoặc trang khác
...
<!-----Main------>
    ...
    <nav class="list-group">
        <a class="list-group-item active" href="TrangTTCN_Admin.php"> Tài Khoản</a>
    ...
    <article class="card mb-3">
        <div class="card-body">
            <figure class="icontext">
                <div class="icon">
                    <img class="rounded-circle img-sm border" src="images/avatars/odegaard.jpg">
                </div>
                <div class="text">
