...
// Kiểm tra nếu có ID khách hàng được chuyển từ trang trước
if (isset($_GET['sid'])) {
    $id_khachhang = $_GET['sid'];

    // Lấy thông tin khách hàng từ cơ sở dữ liệu dựa trên ID
    ...
    echo "ID khách hàng không được cung cấp!";
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sql = "UPDATE khachhang SET hoten_kh = :hoten_kh, ngaysinh = :ngaysinh, gioitinh = :gioitinh, sdt_kh = :sdt_kh, district_id = :district_id, province_id = :province_id, wards_id = :wards_id, Thon_SoNha = :thon_sonha WHERE id_khachhang = :id_khachhang";
