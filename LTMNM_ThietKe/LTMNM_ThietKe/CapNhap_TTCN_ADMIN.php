...
// Kiểm tra nếu không tìm thấy thông tin nhân viên
if (!$employee) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE nhanvien SET Hoten_NhanVien = :hoten_nv, NgaySinh = :ngaysinh, gioitinh = :gioitinh, district_id = :district_id, province_id = :province_id, wards_id = :wards_id, Thon_SoNha = :Thon_SoNha WHERE UserName = :username";
    $stmt_update = $conn->prepare($sql_update);
    $stmt_update->bindParam(':hoten_nv', $hoten_nv);
...
$(document).ready(function(){
    ...
    <div class="col-xl-3 col-lg-3 col-md-4 col-6">
        ...
        <a class="list-group-item active" href="CapNhap_TTCN_ADMIN.php"> Cập Nhập Thông Tin </a>
    ...
    <form method="POST" action="">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="username" value="<?php echo htmlspecialchars($employee['UserName']); ?>" disabled>
        </div>
        <div class="form-group">
            <label>Tên Nhân Viên</label>
            <input type="text" class="form-control" name="hoten_nv" value="<?php echo htmlspecialchars($employee['Hoten_NhanVien']); ?>">
        </div>
        <div class="form-group">
            <label>Ngày Sinh</label>
            <input type="date" class="form-control" name="ngaysinh" value="<?php echo htmlspecialchars($employee['NgaySinh']); ?>">
        </div>
        <div class="form-group">
            <label>Giới Tính</label>
            <select class="form-control" name="gioitinh">
                <option value="1" <?php if ($employee['gioitinh'] == 1) echo "selected"; ?>>Nam</option>
                <option value="0" <?php if ($employee['gioitinh'] == 0) echo "selected"; ?>>Nữ</option>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="Thon_SoNha" value="<?php echo htmlspecialchars($employee['Thon_SoNha']); ?>">
        </div>
