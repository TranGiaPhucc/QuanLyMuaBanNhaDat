...
$sql = "SELECT nhadat.id_nhadat, nhadat.tinhtrang, nhadat.hinhanh, nhadat.ten_nhadat, nhadat.mota, loai_nhadat.tenloai, 
province.name as province_name, district.name as district_name, wards.name as ward_name
FROM nhadat
...
<div class="container">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <label>
				<?php echo isset($row['ward_name']) ? $row['ward_name'] : ''; ?>,
				<?php echo isset($row['district_name']) ? $row['district_name'] : ''; ?>, 
				<?php echo isset($row['province_name']) ? $row['province_name'] : ''; ?> 
            ...
            <div class="form-group">
                ...
                <label ><img src="images/items/<?php echo $row["hinhanh"]; ?>" width="300" height="200" /></label>
                <span class="form-error"></span>
            </div>
            <div class="form-group">
