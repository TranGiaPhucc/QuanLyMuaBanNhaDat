...
if(isset($_GET['username'])) {
    // Lấy giá trị username từ URL
    $username = $_GET['username'];

    // Lấy thông tin cá nhân từ bảng nhanvien
    $sql_employee = "SELECT * FROM nhanvien WHERE UserName = :username";
    ...
    $name = $employee['Hoten_NhanVien'];
    $dob = $employee['NgaySinh'];
    $gender = ($employee['gioitinh'] == 0) ? "Nữ" : "Nam";
    $email = $user['email'];
    ...
    <div class="col-xl-5 col-lg-3 col-md-4 col-6">
        <aside class="">
            <nav class="list-group">
                ...
                <a class="list-group-item" href="#">Danh Mục Yêu Thích</a>
